        ...
        try:    
            ...
            # In ajax_view.py
                ...
                if request.user.is_authenticated:
                    ...
                    # logging runing assistant query
                    logger.info(f"Running assistant query: {user_query}, as user: {request.user.username}")
                    ...
                    try:
                        ...
                        # log the error
                        logger.error(f"Error running assistant query: {e}")
