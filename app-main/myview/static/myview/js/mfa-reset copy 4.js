...
class AppUtils {
    ...
    displayAuthenticationMethod(app, authenticationMethod) {
        ...
        try {
                ...
                'eventListeners': [
                    {
                        ...
                        handler: async function () {
                            ...
                            try {
                                ...
                                // how do i pass in modelInstance here?
                                modalInstance.hide();
            ...
            // from here
            const modelInstance = app.baseAppUtils.setModal(`#${card.deleteButtonId}`, `delete-${card.deleteButtonId}`, deleteModalOptions); // Set the modal for the delete button
