...
//     const url = `http://localhost:6081/v1.0/graph/get-user/${encodeURIComponent(username)}`;
//     const headers = {
//         'accept': 'application/json',
//         'Authorization': 'Token <token>', // Replace <token> with your actual token
//         'X-CSRFToken': '62hbywuYlXGEUtQk8DaWOLvGAkTp4x2mrgojINqqmKkeJxbRI94DW1uI1sLyCHLz' // CSRF token as needed
//     };
...
//   getUserInfo('vicre-test01@dtudk.onmicrosoft.com');
