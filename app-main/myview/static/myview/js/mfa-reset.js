...
function updateAuthenticationMethods() {
    ...
    // JSON.parse(sessionStorage.getItem('userPrincipalObj')).authentication_methods[0].value[0].id
    // >> 'f18a98ad-7fc4-4294-8814-4fbdea4ef13b'
...
//     // Assuming you've stored the method ID in a variable `methodIdToDelete`
//     console.log('Deleting method with ID:', methodIdToDelete); // Replace this with your actual deletion logic
...
//     fetch(`/your-delete-endpoint/${methodId}/`, {
//         method: 'DELETE',
//         headers: {
...
//     .then(data => {
//         updateSessionStorage(data);
//         updateAuthenticationMethods(); // Refresh your authentication methods display
