...
urlpatterns = [
    ...
    path('active-directory/computer/v1-0-0/<str:computer_name>/', ADComputerViewSet.as_view({'get': 'retrieve'})),

    # this endpoint returns a list of computers that thats has not been logged in for x days - default 30 days    
    path('active-directory/computer/v1-0-0/inactive-computers', ADInactiveComputersViewset.as_view({'get': 'retrieve'})),
