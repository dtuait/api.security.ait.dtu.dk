...
Build
-----
    docker build -f .devcontainer/.docker-image-builder-archive/__owner__dtuait__project__api-security-ait-dtu-dk__image__app-main__tag__python-3.12-bookworm-django-5.1.1-postgres-16-26-09-2025/Dockerfile -t app-main:python-3.12-django-5.1-postgres-16 .
